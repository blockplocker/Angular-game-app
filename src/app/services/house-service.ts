...
export class HouseService {
  protected houseListingList: IhouseListing[] = [
    {
      id: 0,
  ...
  getAllHouseListings(): IhouseListing[] {
    return this.houseListingList;
  }
  getHouseListingById(id: number): IhouseListing | undefined {
    return this.houseListingList.find(houseListing => houseListing.id === id);
  }
